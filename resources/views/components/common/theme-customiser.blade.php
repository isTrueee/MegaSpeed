<div x-data="customizer">
    ...
    <nav class="bg-white fixed ltr:-right-[400px] rtl:-left-[400px] top-0 bottom-0 w-full max-w-[400px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-[right] duration-300 z-[51] dark:bg-[#0e1726] p-4"
        ...
        <a href="javascript:;"
            class="absolute top-0 bottom-0 flex items-center justify-center w-12 h-10 my-auto text-white cursor-pointer bg-primary ltr:rounded-tl-full rtl:rounded-tr-full ltr:rounded-bl-full rtl:rounded-br-full ltr:-left-12 rtl:-right-12"
        ...
        <div class="h-full overflow-x-hidden overflow-y-auto perfect-scrollbar">
            <div class="relative pb-5 text-center">
                ...
                <h4 class="mb-1 dark:text-white">THEMES</h4>
            </div>
